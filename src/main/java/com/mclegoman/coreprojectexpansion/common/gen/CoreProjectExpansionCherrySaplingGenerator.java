...
public class CoreProjectExpansionCherrySaplingGenerator extends SaplingGenerator {
    public CoreProjectExpansionCherrySaplingGenerator() {
    }

    @Nullable
    @Override
    protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return CoreProjectExpansionConfiguredFeatures.CHERRY_TREE;
    }
}
