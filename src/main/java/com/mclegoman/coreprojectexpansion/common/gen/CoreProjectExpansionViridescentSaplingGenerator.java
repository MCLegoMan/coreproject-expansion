...
public class CoreProjectExpansionViridescentSaplingGenerator extends SaplingGenerator {
    public CoreProjectExpansionViridescentSaplingGenerator() {
    }

    @Nullable
    @Override
    protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return CoreProjectExpansionConfiguredFeatures.VIRIDESCENT_TREE;
    }
}
