...
public class CoreProjectExpansionVioletSaplingGenerator extends SaplingGenerator {
    public CoreProjectExpansionVioletSaplingGenerator() {
    }

    @Nullable
    @Override
    protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return CoreProjectExpansionConfiguredFeatures.VIOLET_TREE;
    }
}
