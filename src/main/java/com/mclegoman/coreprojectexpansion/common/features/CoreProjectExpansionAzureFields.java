...
public class CoreProjectExpansionAzureFields {
    ...
    private static GenerationSettings createGenerationSettings(FabricDynamicRegistryProvider.Entries entries) {
        ...
        builder.feature(GenerationStep.Feature.VEGETAL_DECORATION, entries.ref(CoreProjectExpansionPlacedFeatures.AZURE_TREES));
