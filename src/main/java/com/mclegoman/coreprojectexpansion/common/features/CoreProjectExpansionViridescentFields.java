...
public class CoreProjectExpansionViridescentFields {
    ...
    private static GenerationSettings createGenerationSettings(FabricDynamicRegistryProvider.Entries entries) {
        ...
        builder.feature(GenerationStep.Feature.VEGETAL_DECORATION, entries.ref(CoreProjectExpansionPlacedFeatures.VIRIDESCENT_TREES));
    ...
    private static SpawnSettings createSpawnSettings() {
        ...
        builder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityType.RABBIT, 16, 4, 8));
        return builder.build();
    }
}